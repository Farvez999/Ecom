...
//                Log.i("Responsestring", response.body().toString());
            ...
            public void onFailure(Call<String> call, Throwable t) {
                Toast.makeText(UserDashboardActivity.this, "Error" + t, Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void Order_writeRecycler(String jsonresponse) {
        try {
            ...
            mExampleAdapter = new DasboardOrderAdapter(UserDashboardActivity.this, mExampleList);
