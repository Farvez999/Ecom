...
//        Toast.makeText(this, "Check session Manager"+sessionManager.getToken(), Toast.LENGTH_SHORT).show();
    ...
    private void messageSend() {
        ...
        StringRequest request = new StringRequest(Request.Method.POST, YourUrl, new com.android.volley.Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                if (!response.equals(null)) {
                    ...
                    Toast.makeText(MessageActivity.this, "Your Array Response "+response.toString(), Toast.LENGTH_SHORT).show();
                } else {
                    Log.e("Your Array Response", "Data Null");
                    Toast.makeText(MessageActivity.this, "b"+response, Toast.LENGTH_SHORT).show();
                }
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(MessageActivity.this, "eee"+error, Toast.LENGTH_SHORT).show();
            }
        }) {
        ...
        Toast.makeText(MessageActivity.this, ""+sessionManager.getToken(), Toast.LENGTH_SHORT).show();
